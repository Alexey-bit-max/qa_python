...
class TestBooksCollector:
    ...
    # Проверяем отсутствие жанра у новой книги
    ...
    # Исправленный тест на получение жанра
    ...
    # Проверяем список книг по жанру
