class BooksCollector:
    ...
    def add_new_book(self, name):
        # Исправленная проверка существования книги
        if name not in self.books_genre and isinstance(name, str) and 0 < len(name.strip()) < 41:
    ...
    def get_books_with_specific_genre(self, genre):
        ...
        if genre in self.genre:  # Убрана лишняя проверка
